<?php
/*
Plugin Name: sohis-sri
Plugin URI: http://wordpress.org/plugins/sohis-sri/
Description: [sohissri place_id=1] shortcode which adds an iframe with SOHiS content
Version: 1.3.7
Author: SOHiS 
...
function sohis_sri_plugin_add_shortcode_cb($atts)
{
...
add_shortcode('sohissri', 'sohis_sri_plugin_add_shortcode_cb');
